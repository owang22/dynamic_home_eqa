...
|---|---|---|---|
| llm · tour_anonymized | 2250 | 0.571 ± 0.010 | 1.461 ± 0.029 |
| llm · tour_named | 2250 | 0.603 ± 0.010 | 1.347 ± 0.030 |
| llm_fixed · tour_anonymized | 2250 | 0.620 ± 0.010 | 1.331 ± 0.027 |
| llm_fixed · tour_named | 2250 | 0.620 ± 0.010 | 1.332 ± 0.028 |
...
|---|---|---|---|---|
| llm · tour_named · f0 | 0.673 ± 0.010 | 1.115 ± 0.032 | 21.4 | 0 |
| llm · tour_named · f0.1 | 0.684 ± 0.010 | 1.074 ± 0.031 | 21.4 | 50 |
| llm_fixed · tour_named · f0 | 0.712 ± 0.010 | 0.987 ± 0.028 | 21.4 | 0 |
| llm_fixed · tour_named · f0.1 | 0.700 ± 0.010 | 1.025 ± 0.029 | 21.4 | 50 |
...
|---|---|---|---|---|
| active · llm · tour_named · f0 | 2 | 2 | 1191.3 | d3 scheduled → revised; d7 scheduled → revised |
| active · llm · tour_named · f0.1 | 2 | 2 | 1170.7 | d3 scheduled → revised; d7 scheduled → revised |
| active · llm_fixed · tour_named · f0 | 0 | None | None |  |
| active · llm_fixed · tour_named · f0.1 | 0 | None | None |  |
| passive · llm · tour_anonymized | 2 | 0 | 0.0 | d3 scheduled → revised; d7 scheduled → revised |
| passive · llm · tour_named | 2 | 0 | 0.0 | d3 scheduled → revised; d7 scheduled → revised |
| passive · llm_fixed · tour_anonymized | 0 | None | None |  |
| passive · llm_fixed · tour_named | 0 | None | None |  |

Tour-start elicitation (last elicit run): hh_001 tour_named 544s, 15291 tokens, 108.85s/hypothesis; hh_001 tour_anonymized 499s, 14019 tokens, 99.78s/hypothesis
...
|---|---|---|---|---|
| passive · llm · tour_named | 1.347 | 1.275 | 0.072 | {'hyp2': 11, 'hyp1': 11, 'stat': 7, 'hyp4': 3, 'hyp3': 3} |
| passive · llm · tour_anonymized | 1.461 | 1.370 | 0.092 | {'hyp2': 11, 'hyp1': 14, 'stat': 9, 'hyp3': 1} |
| passive · llm_fixed · tour_named | 1.332 | 1.234 | 0.098 | {'hyp2': 11, 'hyp1': 16, 'stat': 5, 'hyp5': 1, 'hyp4': 1, 'hyp3': 1} |
| passive · llm_fixed · tour_anonymized | 1.331 | 1.287 | 0.045 | {'hyp1': 23, 'hyp2': 1, 'stat': 5, 'hyp4': 2, 'hyp5': 3, 'hyp3': 1} |
