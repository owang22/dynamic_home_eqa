...
embodied_m3_gate.py's module docstring and results/reports/conformal_coverage_finding_full.md
...
def main() -> None:
    ...
    ap.add_argument("--out-dir", default=str(_DYNAMIC_EQA / "results" / "e1e4"))
