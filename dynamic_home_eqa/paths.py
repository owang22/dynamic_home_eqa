...
PACKAGE_ROOT is the installed dynamic_home_eqa package directory (code).
REPO_ROOT is its parent: the repo checkout, where all data and output
...
REPO_ROOT = pathlib.Path(
    os.environ.get("DYNAMIC_HOME_EQA_ROOT", str(PACKAGE_ROOT.parent))
).resolve()
