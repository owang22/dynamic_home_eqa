...
class NavMeshConfig:
    ...
    the D0/D1 navmesh diagnostics (scripts/diagnose_navmesh_islands.py;
    this docstring is the durable record of the retired D1 sweep's
    winning config) found scene 102343992's interior fragmented into ~6 disconnected
