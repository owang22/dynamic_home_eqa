# Household hh_s11 — five days, Wednesday to Sunday
...
18:14  Hana finishes resting on the couch
          ...
          book_hana → couch_l1: book dropped on the couch [sick_day:resident_1]
          water_bottle_hana → sink_k1: used, so it goes in the sink [sick_day:resident_1]
18:15  Hana — breakfast in the kitchen; brings mug_hana from coffee_table_l1, bowl_hana from cupboard_k1, tablet_hana from coffee_table_l1
...
19:07  Priya is back from walking the dog
          ...
          shoes_priya → shoe_rack_e1: put away in its usual place after the trip
          keeps phone_priya for cooking dinner
19:07  Priya — cooking dinner in the kitchen [shifted by guest_visit]; brings pan_shared from cupboard_k1, kitchen_knife_shared from drawer_k_k1, spatula_shared from drawer_k_k1, pot_shared from cupboard_k1, recipe_book_shared from pantry_shelf_k1
19:10  Hana finishes laundry
...
19:10  Hana — a short break in the kitchen [because of laundry_day]
19:20  Hana — laundry in the bathroom (bout 2/4) [because of laundry_day]; brings laundry_basket_shared from bedroom_floor_b1, towel_hana from bed_b1, blanket_shared from bed_b1
19:30  Hana finishes laundry
          blanket_shared → bed_b1: washed blanket airing on the bed [laundry_day]
          laundry_basket_shared → bedroom_floor_b1: basket left in the bedroom while things dry [laundry_day]
          towel_hana → bed_b1: clean towel folded on the bed [laundry_day]
