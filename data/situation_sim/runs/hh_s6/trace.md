# Household hh_s6 — five days, Wednesday to Sunday
...
07:46  Omar leaves for walking the dog (back 08:11); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
...
08:11  Omar is back from walking the dog
          ...
          keeps jacket_omar, phone_omar, shoes_omar for work
...
18:11  Omar leaves for walking the dog (back 18:41); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
...
21:25  Omar — evening TV in the living (bout 2/4); brings mug_omar from kitchen_table_k1, glasses_omar from nightstand_b1, snack_bowl_shared from sink_k1
...
21:49  Omar — evening TV in the living (bout 3/4); brings remote_shared from tv_stand_l1, mug_omar from kitchen_table_k1, glasses_omar from armchair_l1
21:57  Leo finishes feeding the dog
          dog_bowl_shared → counter_k1: WHIM — was heading for floor_k_k1 (used, so it goes in the sink) but landed on counter_k1 instead
21:57  Leo — unpacking the shopping in the kitchen (grocery_run habit); brings shopping_bag_shared from chair_k1
...
22:09  Omar — evening TV in the living (bout 4/4); brings remote_shared from tv_stand_l1, mug_omar from kitchen_table_k1, glasses_omar from dresser_b1, snack_bowl_shared from sink_k1
22:12  Leo — cooking dinner in the kitchen [shifted by grocery_delivery]; brings phone_leo from entry_table_e1, pan_shared from cupboard_k1, kitchen_knife_shared from drawer_k_k1, spatula_shared from drawer_k_k1, pot_shared from cupboard_k1, recipe_book_shared from pantry_shelf_k1
...
23:42  Leo — evening TV in the living; brings remote_shared from bookshelf_l1, phone_leo from coffee_table_l1, mug_leo from kitchen_table_k1, snack_bowl_shared from cupboard_k1
...
```
06:21  Leo — morning routine in the bathroom; brings phone_leo from coffee_table_l1
...
07:06  Omar finishes morning routine
          glasses_omar → nightstand_b1: put back in its usual place
          keeps phone_omar for walking the dog
07:06  Omar leaves for walking the dog (back 07:31); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
07:09  Leo — breakfast in the kitchen; brings phone_leo from coffee_table_l1, bowl_leo from cupboard_k1
...
18:04  Omar finishes tidying up
          backpack_omar (from entry_table_e1) → entry_hook_e1: tidied away to its usual place [ep:tidy_mood:resident_1:d1]
          ...
          charger_omar (from entry_table_e1) → desk_b1: tidied away to its usual place [ep:tidy_mood:resident_1:d1]
          ...
          laptop_leo (from entry_hook_e1) → bed_b1: WHIM — was heading for desk_b1 (tidied away to its usual place) but landed on bed_b1 instead [ep:tidy_mood:resident_1:d1]
          laptop_omar (from entry_table_e1) → desk_b1: tidied away to its usual place [ep:tidy_mood:resident_1:d1]
          lunchbox_omar (from entry_table_e1) → cupboard_k1: tidied away to its usual place [ep:tidy_mood:resident_1:d1]
          mug_leo (from kitchen_table_k1) → cupboard_k1: tidied away to its usual place [ep:tidy_mood:resident_1:d1]
          mug_omar (from kitchen_table_k1) → cupboard_k1: tidied away to its usual place [ep:tidy_mood:resident_1:d1]
          notebook_omar (from entry_table_e1) → desk_b1: tidied away to its usual place [ep:tidy_mood:resident_1:d1]
...
```
06:48  Omar — morning routine in the bathroom; brings phone_omar from nightstand_b1, glasses_omar from bed_b1
...
07:37  Omar leaves for walking the dog (back 08:02); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
...
19:07  Omar leaves for walking the dog (back 19:37); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
19:07  Leo — cooking dinner in the kitchen; brings kitchen_knife_shared from drawer_k_k1, spatula_shared from drawer_k_k1, pot_shared from cupboard_k1, recipe_book_shared from pantry_shelf_k1
...
19:47  Omar finishes feeding the dog
          dog_food_bag_shared → pantry_shelf_k1: put back in its usual place
          keys_omar → entry_table_e1: put back in its usual place
19:47  Omar — cooking dinner in the kitchen; brings phone_omar from dresser_b1, pan_shared from sink_k1, cutting_board_shared from sink_k1, kitchen_knife_shared from sink_k1, spatula_shared from dish_rack_k1, pot_shared from sink_k1, recipe_book_shared from pantry_shelf_k1
...
22:01  Leo — a movie in the living (movies habit); brings remote_shared from tv_stand_l1, blanket_shared from couch_l1, snack_bowl_shared from bookshelf_l1, glass_leo from cupboard_k1, phone_leo from nightstand_b1
22:07  Omar — evening TV in the living (bout 2/2); brings remote_shared from armchair_l1, blanket_shared from armchair_l1, snack_bowl_shared from armchair_l1
...
```
07:20  Omar leaves for walking the dog (back 07:45); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
...
08:33  Omar — morning routine in the bathroom; brings phone_omar from desk_b1, glasses_omar from nightstand_b1
08:46  Leo finishes morning routine
...
09:38  Omar finishes breakfast
          mug_omar → sink_k1: used, so it goes in the sink
09:58  Omar — baking in the kitchen (baking habit); brings mixing_bowl_shared from pantry_shelf_k1, baking_tray_shared from pantry_shelf_k1
...
12:20  Leo finishes a shower
          towel_leo → towel_rack_ba1: put back in its usual place
12:20  Leo leaves for errands (back 14:10); takes backpack_leo, keys_leo, wallet_leo, hat_leo, jacket_leo, shoes_leo; never takes phone_leo on errands
14:10  Leo is back from errands
          ...
          wallet_leo → entry_table_e1: put away in its usual place after the trip
14:10  Leo — lunch in the kitchen; brings phone_leo from nightstand_b1, plate_leo from cupboard_k1
...
16:16  Omar — lunch in the kitchen; brings glass_omar from sink_k1
...
18:27  Omar finishes vacuuming
          keeps phone_omar for walking the dog
18:41  Omar leaves for walking the dog (back 19:11); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
...
19:11  Omar — cooking dinner in the kitchen; brings pan_shared from cupboard_k1, kitchen_knife_shared from drawer_k_k1, spatula_shared from drawer_k_k1, pot_shared from cupboard_k1, recipe_book_shared from pantry_shelf_k1
...
20:06  Omar finishes feeding the dog
          dog_bowl_shared → counter_k1: WHIM — was heading for floor_k_k1 (used, so it goes in the sink) but landed on counter_k1 instead
          dog_food_bag_shared → pantry_shelf_k1: put back in its usual place
20:06  Omar — dinner in the kitchen; brings plate_omar from sink_k1, glass_omar from counter_k1, phone_omar from nightstand_b1, water_bottle_omar from sink_k1
20:25  Leo finishes cooking dinner
          kitchen_knife_shared → counter_k1: left where it was used
          pan_shared → sink_k1: used, so it goes in the sink
          pot_shared → sink_k1: used, so it goes in the sink
          recipe_book_shared → pantry_shelf_k1: put back in its usual place
20:25  Leo — dinner in the kitchen; brings glass_leo from sink_k1, water_bottle_leo from dish_rack_k1
20:51  Omar finishes dinner
          ...
          phone_omar → nightstand_b1: put back in its usual place
          plate_omar → dish_rack_k1: left where it was used; kitchen_table_k1 was full, so it went to dish_rack_k1
          water_bottle_omar → dish_rack_k1: WHIM — was heading for sink_k1 (used, so it goes in the sink) but landed on dish_rack_k1 instead
...
21:06  Omar — evening TV in the living (bout 1/2); brings remote_shared from tv_stand_l1, phone_omar from nightstand_b1, blanket_shared from couch_l1, mug_omar from dish_rack_k1, glasses_omar from bathroom_shelf_ba1, snack_bowl_shared from cupboard_k1
...
21:25  Leo finishes washing up
          ...
          water_bottle_leo (from sink_k1) → dish_rack_k1: tidied away to its usual place
21:25  Leo — ironing in the bedroom_1 (ironing habit); brings iron_shared from storage_shelf_s1, ironing_board_shared from storage_floor_s1, phone_leo from nightstand_b1
...
22:23  Omar — evening TV in the living (bout 2/2); brings remote_shared from tv_stand_l1, blanket_shared from couch_l1, mug_omar from cupboard_k1, glasses_omar from bed_b1, snack_bowl_shared from cupboard_k1
22:51  Leo — getting ready for bed in the bedroom_1; brings charger_leo from desk_b1, glass_leo from cupboard_k1
...
```
06:29  Omar leaves for walking the dog (back 06:54); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
06:54  Omar is back from walking the dog
          ...
          shoes_omar → entry_floor_e1: wet shoes left on the entry floor to dry [rain]
07:58  Omar — feeding the dog in the kitchen; brings dog_food_bag_shared from pantry_shelf_k1
08:42  Omar — morning routine in the bathroom; brings phone_omar from nightstand_b1, glasses_omar from nightstand_b1
...
09:23  Omar — breakfast in the kitchen; brings mug_omar from sink_k1, bowl_omar from cupboard_k1
09:44  Leo — morning routine in the bathroom; brings phone_leo from nightstand_b1, skincare_leo from sink_ba_ba1
...
11:33  Omar finishes baking
          baking_tray_shared → dish_rack_k1: WHIM — was heading for counter_k1 (left where it was used) but landed on dish_rack_k1 instead
          mixing_bowl_shared → sink_k1: used, so it goes in the sink
...
12:32  Leo finishes a shower
          towel_leo → towel_rack_ba1: put back in its usual place
12:32  Leo leaves for errands (back 13:38); takes backpack_leo, keys_leo, wallet_leo, hat_leo, jacket_leo, shoes_leo, umbrella_leo; never takes phone_leo on errands
...
14:06  Leo — lunch in the kitchen; brings phone_leo from nightstand_b1, plate_leo from pantry_shelf_k1, glass_leo from cupboard_k1
14:38  Omar finishes vacuuming
          vacuum_cleaner_shared → couch_l1: WHIM — was heading for floor_l_l1 (left where it was used, too tired to put it away) but landed on couch_l1 instead [low_energy:resident_1]
          keeps phone_omar for walking the dog
...
18:43  Leo finishes cooking dinner
          ...
          pot_shared → sink_k1: used, so it goes in the sink
          recipe_book_shared → pantry_shelf_k1: put back in its usual place
18:53  Omar leaves for walking the dog (back 19:23); takes phone_omar, jacket_omar, shoes_omar, dog_leash_shared; never takes keys_omar on walking the dog
19:23  Omar is back from walking the dog
          ...
          shoes_omar → entry_floor_e1: wet shoes left on the entry floor to dry [rain]
          keeps phone_omar for cooking dinner
19:23  Omar — cooking dinner in the kitchen; brings cutting_board_shared from sink_k1, kitchen_knife_shared from sink_k1, pot_shared from sink_k1, recipe_book_shared from pantry_shelf_k1
...
20:18  Omar — dinner in the kitchen; brings glass_omar from dish_rack_k1, phone_omar from nightstand_b1, water_bottle_omar from dish_rack_k1
20:43  Leo finishes dinner
          glass_leo → sink_k1: used, so it goes in the sink
...
21:10  Leo — a call with family in the bedroom_1 [because of ep:long_call_with_a_friend:resident_2:d4]; brings phone_leo from kitchen_table_k1
...
21:18  Omar — evening TV in the living (bout 1/3); brings remote_shared from tv_stand_l1, phone_omar from nightstand_b1, mug_omar from cupboard_k1, glasses_omar from bathroom_shelf_ba1, snack_bowl_shared from cupboard_k1
...
21:50  Leo — a movie in the living (movies habit); brings glass_leo from cupboard_k1
...
22:33  Omar — evening TV in the living (bout 3/3); brings remote_shared from tv_stand_l1, blanket_shared from couch_l1, snack_bowl_shared from side_table_l1
...
23:50  Leo finishes a movie
          blanket_shared → couch_l1: put back in its usual place
          snack_bowl_shared → sink_k1: used, so it goes in the sink
23:50  Leo — getting ready for bed in the bedroom_1; brings charger_leo from desk_b1, glass_leo from coffee_table_l1
