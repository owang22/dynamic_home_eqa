...
def generate(seed: int, out: pathlib.Path, n_days: int = 5, day0: str = "Wednesday") -> None:
    ...
    sits = sample_situations(hh, seed, n_days, events, episodes, day0=day0)
