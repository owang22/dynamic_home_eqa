"""story_calendar: a STORY calendar realized by the RULES engine.

|                        | movement: rules | movement: freeform |
|------------------------|-----------------|--------------------|
| calendar: weekly       | rule_based/     | freeform/          |
| calendar: story        | story_calendar/ | story_driven/      |
...
def run_household(hh_src: pathlib.Path, out_hh: pathlib.Path, model: str,
    ...
    if bind:
        ...
        (out_hh / "bound_program.yaml").write_text(
            "# GENERATED by src/revamp_v2/story_calendar.py --bind-unbound —\n"
    ...
    (out_hh / "story_program.yaml").write_text(
        "# GENERATED by src/revamp_v2/story_calendar.py — the story calendar\n"
    ...
    (out_hh / "expanded_motions.yaml").write_text(
        "# GENERATED by src/revamp_v2/story_calendar.py from the story\n"
