# VENDORED 2026-08-28 from profiles/revamp_v1/simulate_activities.py
# (source commit 6bf88693d059e0e24b2618f87d372ac1c661cfab). Previously
# loaded at runtime via importlib out of the data tree; now an owned
# module of src/households. Owned means owned: fix and edit in place,
# do not sync with the original.
#!/usr/bin/env python3
