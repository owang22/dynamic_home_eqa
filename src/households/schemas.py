# COPIED 2026-08-28 from src/revamp_v2/schemas.py
# (source commit 0d7c3b5e3723d1bf1f46c99dae40780fbde0951e) into the
# self-contained src/households package. Owned copy: edit in place.
# Change from source: absolute same-directory import -> package-relative.
