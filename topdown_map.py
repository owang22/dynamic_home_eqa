...
Requires habitat_sim, which is NOT installed in the environment this repo's
LLM-generation pipeline normally runs in (plain vLLM + transformers). Use a
conda env that has it — e.g. explore-eqa or fine-eqa on this machine — to
import this module.
"""
