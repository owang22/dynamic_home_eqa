...
Two methods only; the 3-day timetable is close to a wash and long-context never inverts, so neither adds to the contrast. It also does not show how MANY questions each bar rests on, which differs a great deal between the kept and handed-over halves.
