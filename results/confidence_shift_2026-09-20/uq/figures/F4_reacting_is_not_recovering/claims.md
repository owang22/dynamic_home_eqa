...
The top panel at the first dotted rule, where every line leaves the promise behind. The ranking is printed on the plot: worst is the never-forgets timetable at 6.3 times its promised rate. Then the lower panel, which shows this is not a failure to react: hand-over roughly doubles at the same moment.
...
|---|---|---|---|---|---|---|
| long-context | 45.5 | 57.9 | 19.0 | 27.7 | 2.8 | 0.1 |
| never-forgets timetable | 21.4 | 70.6 | 12.5 | 63.0 | 6.3 | -10.1 |
| 3-day timetable | 29.1 | 70.4 | 12.5 | 41.2 | 4.1 | -8.6 |
| Perpetua* | 48.7 | 53.3 | 16.5 | 23.9 | 2.4 | -1.3 |
