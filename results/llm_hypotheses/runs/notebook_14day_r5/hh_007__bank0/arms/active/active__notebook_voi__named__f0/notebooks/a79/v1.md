...
- why: [follow_up] The look confirmed that the kitchen counter stages mobile items for multiple residents (Sofia, Mara), not just Leo, but this is consistent with the existing belief that the counter is a general staging area. No belief was contradicted, so the beliefs remain unchanged.
