...
- why: [follow_up] The look at towel_rack_ba1 confirmed towel_mara but showed no other care items, contradicting the previous belief that hairbrush/makeup/meds might co-locate there. This necessitates a belief update to enforce exclusivity for the towel rack.
...
7. **Towel Rack Exclusivity**: towel_rack_ba1 is strictly for towel_mara. Other care items (hairbrush, makeup, meds) do not co-locate there. Priors for non-towel items on towel_rack_ba1 are <0.05.
