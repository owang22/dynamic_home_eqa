...
- why: [review] d04 and d05 looks confirmed that 'static anchors' like cupboard_k1 and entry_hook_e1 are unreliable for specific items (pot_shared_1, headphones_mara, exit items) during the morning window. Conversely, bathroom_shelf_ba1, nightstand_b1, desk_b1, sink_k1, and mug_shared_1 in cupboard_k1 remained stable across multiple looks, even with resident presence. The previous belief in 'Anchor Map' stability was contradicted by d04 06:11 (cupboard empty of pot/headphones) and d05 06:50 (entry hook empty). The new beliefs reflect this bifurcation: stable personal/grooming/sleep items vs. transient kitchen/exit items that drift to active zones (counter/resident) during the morning.
