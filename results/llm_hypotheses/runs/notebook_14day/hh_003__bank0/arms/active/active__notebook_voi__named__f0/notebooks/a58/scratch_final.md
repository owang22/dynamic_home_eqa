# a58 — scratch memory, final (retired d08 Tue 06:30 (population cap); final weight 0.0000)
...
d07 Mon 06:39: d07 Mon 06:39: bathroom_shelf_ba1 held medication_bottle_marisol only. hairbrush_marisol absent (p=0.85 was too high). Shelf is not a stable dual-storage for Marisol's bathroom items; hairbrush likely elsewhere (bedroom/kitchen). Lower hairbrush prior on shelf to <0.30.
