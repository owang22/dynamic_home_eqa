# call 1200 (look_forecast, agent a01) at d13 Sun 06:53
...
NOW: d13 Sun 06:53. The robot is in bedroom_2. Looks left today: 3.
SEEN SO FAR ON THIS QUESTION:
  d13 Sun 06:53 look at bed_b2: (nothing); residents here: nobody
  d13 Sun 06:53 look at crib_b2: blanket_noa; residents here: nobody

REQUEST: the robot is about to look at receptacle bedroom_floor_b2 (in bedroom_2). For up to 8 objects you think may be there right now, give the probability that it is there — each object is its own yes/no probability. Objects you leave out are taken as very unlikely to be there. Name objects by their exact ids from OBJECTS; a class name or a paraphrase is thrown away.

## reply

{"objects": [{"object": "toy_noa", "p": 0.15}, {"object": "book_noa", "p": 0.10}, {"object": "water_bottle_noa", "p": 0.05}, {"object": "medication_bottle_noa", "p": 0.02}, {"object": "backpack_noa", "p": 0.02}, {"object": "towel_noa", "p": 0.01}]}
