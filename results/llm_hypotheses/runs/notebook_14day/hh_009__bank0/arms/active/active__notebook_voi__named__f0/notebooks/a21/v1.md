...
- why: [review] The looks confirmed that entry_hook_e1 is a primary drop-off for outerwear and bags, and that counter_k1 is Priya's morning hub. They also confirmed that desk_b1 is Elias's static work hub but does not reliably hold his small items. The looks refuted the belief that Elias's small items (phone, keys, pen, wallet) are ON_PERSON or on nightstand_b1 in the early morning. The scratch memory taught that towel_noa appears in the bathroom during Priya's morning care routine. These patterns are now incorporated into the beliefs.
