...
Usage:
    ...
    python scripts/gen_dataset.py --n 10 --profile work_from_home_adult

    # Full batch with model selection probe
    python scripts/gen_dataset.py --n 20 --profile family_with_kids \\
        --model Qwen/Qwen3-14B-Instruct --out generation_out/ --report

    # Force regeneration ignoring cache
    python scripts/gen_dataset.py --n 5 --force

    # With specific scene IDs
    python scripts/gen_dataset.py --scenes 102343992 102344280
...
_PKG_ROOT  = pathlib.Path(__file__).parent.parent.resolve()
...
def main() -> None:
    ...
    ap.add_argument("--n", type=int, default=10,
                    help="Number of scenes to process (default: 10)")
    ap.add_argument("--profile", default="work_from_home_adult",
