...
# that glob (KeyError: 'fingerprint', caught while regenerating the table
# during this same batch). embodied_results/diagnostics/ is outside the
# top-level glob, the same way embodied_results/stale/ already is.
