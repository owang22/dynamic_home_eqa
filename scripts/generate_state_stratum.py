...
Usage:
    python3 scripts/generate_state_stratum.py --scene 102343992 --profile family_with_kids
    python3 scripts/generate_state_stratum.py --scene 102344049 --profile family_with_kids
    python3 scripts/generate_state_stratum.py --scene 102343992 --profile family_with_kids \\
