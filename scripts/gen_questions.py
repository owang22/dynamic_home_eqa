...
Usage:
  python scripts/gen_questions.py results/102343992_work_from_home_adult/
  python scripts/gen_questions.py results/                  # all subdirs
  python scripts/gen_questions.py results/ --n-windows 10
"""
