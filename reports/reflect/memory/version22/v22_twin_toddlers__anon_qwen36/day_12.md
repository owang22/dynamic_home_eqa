...
1. (p=0.96) Hybrid Office Worker (Commute + WFH) — The weekend pattern (Day 12) shows object_14 (likely a bag/briefcase) remaining at receptacle_11 (home desk) until 18:30, confirming a relaxed, non-commute Saturday. This reinforces the distinction between weekday 'work item' presence and weekend leisure/stay-at-home behavior. The Friday late return (21:45) and mid-morning home presence remain consistent with a hybrid schedule.
2. (p=0.03) Remote Worker with Errands — While the weekend stay-at-home behavior fits, the consistent early departures on Wed/Thu (06:36) and the specific 'work item' (object_10) presence at the desk during weekdays make this less likely than the hybrid model. The probability decreases slightly as the 'work item' distinction persists.
...
- Day 12, 18:30 — object_14 at receptacle_11 (Saturday stay-at-home; confirms weekend relaxation pattern)

## Notes
Day 12 (Saturday) confirms object_14 remains at the home desk (receptacle_11) until 18:30, indicating no morning commute or errand run. This strengthens the distinction between weekday 'work item' (object_10/14) presence and weekend leisure. Need to verify if object_14 is the same as object_10 (work item) or a different bag. The Friday late return (21:45) and mid-morning home presence remain consistent with a hybrid schedule. Weekend patterns (Sat/Sun) remain distinct with later starts.