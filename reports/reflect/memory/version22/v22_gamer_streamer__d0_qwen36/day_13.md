...
1. (p=0.80) Hybrid Worker with Late-Night Leisure — Friday departure (keys) confirms non-strict WFH. Persistent late-night activity (01:43 phone, 21:22 headset) suggests evening wind-down. Weekend inactivity (no keys, late coffee) supports a relaxed weekend routine for a standard worker.
2. (p=0.15) Night-Shift Worker — Late-night object movement combined with daytime inactivity on weekends could indicate a night shift ending in the morning. However, the specific Friday departure at 12:48 is less typical for a rigid night-shift schedule unless it's a day off. Probability remains low but non-zero due to lack of morning activity.
...
## Selected evidence
- Day 13, 10:55 — coffee_mug at table_d1 (Weekend late morning activity; confirms resident is awake and active, but no keys present, reinforcing weekend inactivity pattern)
...
## Notes
Day 13 (Sunday) shows late morning coffee at 10:55, confirming the resident is awake but not leaving (no keys). This reinforces the 'weekend inactivity' pattern observed on Saturday. The Friday departure (keys) appears to be a weekly event, possibly a commute or errand. The late-night pattern (headset/phone) persists into the weekend, suggesting leisure or irregular work hours. Need to observe Monday to see if keys appear again, confirming the weekly commute pattern. The 'Night-Shift' hypothesis is slightly weakened by the lack of morning activity on Saturday/Sunday, but the late-night activity remains strong.